...
const patchSchema = z.object({
  ...
  profile_visibility: z.enum(["everyone", "subscribers", "nobody"]).optional(),
  message_perm:       z.enum(["everyone", "subscribers", "nobody"]).optional(),
...
function privacyShape(s: Record<string, unknown>) {
  return {
    ...
    allow_comments:   s.allow_comments   ?? true,
    profile_visibility: s.profile_visibility ?? "everyone",
    message_perm:       s.message_perm       ?? "everyone",
