...
import { ArrowLeft, Heart, Lock, Play, Share2 } from 'lucide-react-native';
...
export default function ContentViewerScreen() {
  ...
  return (
    <View style={[styles.screen, { paddingTop: insets.top }]}>
      <View style={styles.header}><Pressable style={styles.iconButton} onPress={() => router.back()}><ArrowLeft size={20} color={T.TEXT} /></Pressable><Text style={styles.headerTitle}>Preview</Text><Pressable style={styles.iconButton}><Share2 size={18} color={T.TEXT_2} /></Pressable></View>
